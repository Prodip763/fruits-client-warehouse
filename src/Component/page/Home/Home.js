...
const Home = () => {
    ...
    return (
        <div className="container mx-auto mt-4">
            ...
            <h2 className="text-pink-500 text-2xl  text-center mt-2 bg-gray-600">Best Deal Forever</h2>
            <div className="mt-3   gap-2 md:flex" >
                ...
                <div className="w-full">
                    <div className="containe ">
                        <img className="rounded-xl w-full mt-1 md:h-48" src={"https://img.freepik.com/free-photo/tasty-ripe-sweet-healthy-blackberry_114579-11249.jpg?size=626&ext=jpg&ga=GA1.2.86413933.1642213775"}></img>
